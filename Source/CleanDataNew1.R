...
CleanDataNew1 <- function( dna_samples                     ## DNA samples file  
                          ...
                          , age.label.lookup = NULL)
{
  ...
  #two age columns now so use ^and $ to find exact match
  ...
  #   c("Id","RovBaseId","DNAID","Species","Sex","Date","East","North")[!c("Id","RovBaseId","DNAID","Species","Sex","Date","East","North")%in%names(dna_samples)]
  #c("Id","RovBaseId","DNAID","Species","Sex","Date","East","North")[!c("Id","RovBaseId","DNAID","Species","Sex","Date","East","North")%in%names(dead_recoveries)]
  ...
  proj4string(myData) <-  suppressWarnings(proj4string(country_polygon))
