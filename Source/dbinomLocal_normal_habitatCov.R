#' Local evaluation of a density-dependent binomial SCR detection process 
#'
#' The \code{dbinomLocal_normal_habitatCov} distribution is a NIMBLE custom 
#' distribution which can be used to model 
#' and simulate binomial observations (x) of a single individual over a set of 
#' traps defined by their coordinates \emph{trapCoords}
#' the distribution assumes that an individual’s detection probability at any 
#' trap follows a half-normal function of the distance between 
#' the individual's activity center (s) and the trap location. All coordinates 
#' (\code{s} and \code{trapCoords}) should be scaled to the habitat
#'  (see \code{\link{scaleCoordsToHabitatGrid}})
#' 
#' The \code{dbinomLocal_normal_habitatCov} distribution incorporates three 
...
#' \item A sparse matrix representation (\emph{x}, \emph{detIndices} and 
#' \emph{detNums}) of the observation data to reduce the size of objects to 
#' be processed.
#' \item An indicator (\emph{indicator}) to shortcut calculations for individuals 
#' unavailable for detection.
#' }
#' 
#' The \code{dbinomLocal_normal_habitatCov} distribution requires x- and y- 
...
#'
#' In addition, the \code{dbinomLocal_normal_habitatCov} distribution assumes that
#'  the scale parameter depends on the activity center location in the habitat.
#'
#' When the aim is to simulate detection data: 
#' \enumerate{
#' \item \emph{x} should be provided using the \emph{yCombined} object as 
#' returned by \code{\link{getSparseY}}, 
...
#' 
#' 
#' @name dbinomLocal_normal_habitatCov
#'
...
#' @param sigma0 Intercept for the scale parameter of the half-normal detection function.
#' @param habitatCov Vector of habitat covariate.
#' @param betaHabitat beta coefficient of the effect of the habitat covariate.
...
#' dbinomLocal_normal_habitatCov(x=SparseY$y[i,,1],
...
#' dbinomLocal_normal_habitatCov(x=SparseY$yCombined[i,,1],
#'                    size=rep(1,4),
#'                    p0 = p0,
#'                    sigma= sigma, 
#'                    s=s[i,1:2],
...
#' @rdname dbinomLocal_normal_habitatCov
#' @export
dbinomLocal_normal_habitatCov <- nimbleFunction(
  run = function( x = double(1),
    ...
    ## Retrieve the value of the habitat covariate
    thisHabitatCov <- habitatCov[sID]
    ...
    sigma <- exp(log(sigma0) + betaHabitat * thisHabitatCov)
...
#' @rdname dbinomLocal_normal_habitatCov
#' @export
rbinomLocal_normal_habitatCov <- nimbleFunction(
  run = function( n = double(0, default = 1),
    ...
    ## Specify return type
    returnType(double(1))
    if(detNums >= 0) stop("Random generation for the rbinomLocal_normal_habitatCov distribution is not currently supported without combining all individual detections information in one vector. See 'getSparseY()'")
...
# dbinomLocal_normal_habitatCov
registerDistributions(
  list(
    dbinomLocal_normal_habitatCov = list(
      BUGSdist ='dbinomLocal_normal_habitatCov(detNums       , detIndices    , size, p0       , p0Traps    , sigma0, habitatCov, betaHabitat, s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor     , habitatGrid, indicator, lengthYCombined)',
      Rdist = c('dbinomLocal_normal_habitatCov(detNums       , detIndices    , size, p0 = -999, p0Traps    , sigma0, habitatCov, betaHabitat, s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor     , habitatGrid, indicator, lengthYCombined)',
                'dbinomLocal_normal_habitatCov(detNums       , detIndices    , size, p0 = -999, p0Traps    , sigma0, habitatCov, betaHabitat, s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor     , habitatGrid, indicator, lengthYCombined = 0)',
                'dbinomLocal_normal_habitatCov(detNums = -999, detIndices    , size, p0 = -999, p0Traps    , sigma0, habitatCov, betaHabitat, s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor     , habitatGrid, indicator, lengthYCombined)',
                'dbinomLocal_normal_habitatCov(detNums = -999, detIndices = s, size, p0 = -999, p0Traps    , sigma0, habitatCov, betaHabitat, s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor     , habitatGrid, indicator, lengthYCombined)',
                'dbinomLocal_normal_habitatCov(detNums = -999, detIndices = s, size, p0 = -999, p0Traps    , sigma0, habitatCov, betaHabitat, s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor = 1 , habitatGrid, indicator, lengthYCombined)',
                'dbinomLocal_normal_habitatCov(detNums = -999, detIndices    , size, p0 = -999, p0Traps    , sigma0, habitatCov, betaHabitat, s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor     , habitatGrid, indicator, lengthYCombined = 0)',
                'dbinomLocal_normal_habitatCov(detNums = -999, detIndices = s, size, p0 = -999, p0Traps    , sigma0, habitatCov, betaHabitat, s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor = 1 , habitatGrid, indicator, lengthYCombined = 0)',
                'dbinomLocal_normal_habitatCov(detNums       , detIndices    , size, p0 = -999, p0Traps    , sigma0, habitatCov, betaHabitat, s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor = 1 , habitatGrid, indicator, lengthYCombined)',
                'dbinomLocal_normal_habitatCov(detNums = -999, detIndices    , size, p0 = -999, p0Traps    , sigma0, habitatCov, betaHabitat, s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor = 1 , habitatGrid, indicator, lengthYCombined)',
                'dbinomLocal_normal_habitatCov(detNums = -999, detIndices    , size, p0 = -999, p0Traps    , sigma0, habitatCov, betaHabitat, s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor = 1 , habitatGrid, indicator, lengthYCombined = 0)',
                'dbinomLocal_normal_habitatCov(detNums       , detIndices    , size, p0 = -999, p0Traps    , sigma0, habitatCov, betaHabitat, s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor = 1 , habitatGrid, indicator, lengthYCombined = 0)',
                 
                'dbinomLocal_normal_habitatCov(detNums       , detIndices    , size, p0       , p0Traps = s, sigma0, habitatCov, betaHabitat,s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor     , habitatGrid, indicator, lengthYCombined = 0)',
                'dbinomLocal_normal_habitatCov(detNums       , detIndices    , size, p0       , p0Traps = s, sigma0, habitatCov, betaHabitat,s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor     , habitatGrid, indicator, lengthYCombined)',
                'dbinomLocal_normal_habitatCov(detNums = -999, detIndices    , size, p0       , p0Traps = s, sigma0, habitatCov, betaHabitat,s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor     , habitatGrid, indicator, lengthYCombined)',
                'dbinomLocal_normal_habitatCov(detNums = -999, detIndices = s, size, p0       , p0Traps = s, sigma0, habitatCov, betaHabitat,s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor     , habitatGrid, indicator, lengthYCombined)',
                'dbinomLocal_normal_habitatCov(detNums = -999, detIndices = s, size, p0       , p0Traps = s, sigma0, habitatCov, betaHabitat,s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor = 1 , habitatGrid, indicator, lengthYCombined)',
                'dbinomLocal_normal_habitatCov(detNums = -999, detIndices    , size, p0       , p0Traps = s, sigma0, habitatCov, betaHabitat,s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor     , habitatGrid, indicator, lengthYCombined = 0)',
                'dbinomLocal_normal_habitatCov(detNums = -999, detIndices = s, size, p0       , p0Traps = s, sigma0, habitatCov, betaHabitat,s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor = 1 , habitatGrid, indicator, lengthYCombined = 0)',
                'dbinomLocal_normal_habitatCov(detNums       , detIndices    , size, p0       , p0Traps = s, sigma0, habitatCov, betaHabitat,s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor = 1 , habitatGrid, indicator, lengthYCombined)',
                'dbinomLocal_normal_habitatCov(detNums = -999, detIndices    , size, p0       , p0Traps = s, sigma0, habitatCov, betaHabitat,s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor = 1 , habitatGrid, indicator, lengthYCombined)',
                'dbinomLocal_normal_habitatCov(detNums = -999, detIndices    , size, p0       , p0Traps = s, sigma0, habitatCov, betaHabitat,s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor = 1 , habitatGrid, indicator, lengthYCombined = 0)',
                'dbinomLocal_normal_habitatCov(detNums       , detIndices    , size, p0       , p0Traps = s, sigma0, habitatCov, betaHabitat,s, trapCoords, localTrapsIndices, localTrapsNum, resizeFactor = 1 , habitatGrid, indicator, lengthYCombined = 0)'
      ),
      types = c('value = double(1)',
                'detNums = double(0)','detIndices = double(1)',
                'size = double(1)', 'p0Traps = double(1)', 'sigma0 = double(0)',
                'habitatCov = double(1)', 'betaHabitat = double(0)',
