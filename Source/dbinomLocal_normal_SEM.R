...
#'
#' The \code{dbinomLocal_normal_SEM} distribution is a NIMBLE custom 
...
#' 
#' The \code{dbinomLocal_normal_SEM} distribution incorporates three 
...
#' }
#' 
#' The \code{dbinomLocal_normal_SEM} distribution requires x- and y- 
...
#'
#' In addition, the \code{dbinomLocal_normal_SEM} distribution assumes that
...
#' dbinomLocal_normal_SEM(x=SparseY$y[i,,1],
...
#' dbinomLocal_normal_SEM(x=SparseY$yCombined[i,,1],
#'                    size=rep(1,4),
#'                    p0 = p0,
#'                    sigma= sigma, 
#'                    s=s[i,1:2],
...
#' @rdname dbinomLocal_normal_SEM
#' @export
dbinomLocal_normal_SEM <- nimbleFunction(
  run = function( x = double(1),
    ...
    numHabCovs <- length(betaHab)
    thisHabCovs <- habCovs[sID,1:numHabCovs]
    thisDensCov <- densCov[sID]
    ...
    sigma <- exp(log(sigma0) +
                   betaDens * thisDensCov +
                   inprod(betaHab[1:numHabCovs], thisHabCovs[1:numHabCovs]))
...
#' @rdname dbinomLocal_normal_SEM
#' @export
rbinomLocal_normal_SEM <- nimbleFunction(
