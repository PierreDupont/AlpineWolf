...
modelCode <- nimbleCode({
  ...
  # alpha0 =  2 * pi * sigma^2 * lambda0
  # lambda0 =  alpha/ (2*pi*sigma^2) 
  alpha0 ~ dgamma(1,1)
  
  lambda0[1,1] <- alpha0/(6.283185*sigma[1,1]^2)
  lambda0[2,1] <- alpha0/(6.283185*sigma[2,1]^2)
  lambda0[3,1] <- alpha0/(6.283185*sigma[3,1]^2) 
  lambda0[1,2] <- alpha0/(6.283185*sigma[1,2]^2) 
  lambda0[2,2] <- alpha0/(6.283185*sigma[2,2]^2)
  lambda0[3,2] <- alpha0/(6.283185*sigma[3,2]^2)
